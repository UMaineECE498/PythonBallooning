...
###################################################################
# This module accesses and downloads the STRM elevation data
####################################################################
...
def getElevation(lat, lon):
	...
	filepath = os.path.join(strmdataloc, _getFileNameFromDegrees(lat, lon)) 
	...
	if (os.path.exists(fileName) == False):
		...
		zipName = os.path.join(strmdataloc, fileName + '.zip')
